...
export default function Contact() {
  return (
    <div
      className={
        "flex flex-wrap lg:flex-nowrap justify-between items-center md:mx-24 mt-14 md:mt-24"
      }
    >
      <div className="flex flex-col justify-center items-center text-center lg:justify-start lg:items-start lg:text-start w-full h-full mb-4">
        ...
        >
          If you have a project you'd like to discuss or simply want to say hello, feel free to
          reach out to me at any platform listed below. I'm always interested in meeting new people
